        ...
        React.createElement('section', { className: 'mgw-group' },
          ...
          React.createElement('div', { className: 'mgw-card' },
            ...
            pairingMode === 'relay'
              ? (relayInfo
                  ? React.createElement('div', { className: 'mgw-field' },
                      // Verified on 2026-09-23: scanning a relay payload makes
                      // the mini-program fail locally with "地址未经此主机确认"
                      // and open no connection at all, while a direct payload
                      // pairs and queries normally. Say so instead of letting
                      // the operator chase a relay bug that is not one.
                      React.createElement('div', { className: 'mgw-note mgw-danger' },
                      ...
                      React.createElement('div', { className: 'mgw-callout' },
                        ...
                        React.createElement('div', { className: 'mgw-callout-text' },
                          '中继链路本身已验证可用。若扫码后仍报「地址未经此主机确认」，请确认小程序版本支持中继协议（v3 载荷）。')),
                  ...
                  : React.createElement('div', { className: 'mgw-field' },
                      React.createElement('div', { className: 'mgw-note mgw-danger' }, '尚未收到 connector 注册。请确认 /vol1/app/dsh-relay 的 dsh-connector 正在运行——它连上中继后会自动上报身份。')))
              : React.createElement('div', { className: 'mgw-field' },
